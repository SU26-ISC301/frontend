...
const pageComponents = {
  ...
  'ho-tro': (props) => <SimplePanel {...props} icon={MessageSquareText} title="Hỗ trợ" desc="Yêu cầu hỗ trợ, đổi trả và trao đổi với shop." items={['Chat với shop', 'Yêu cầu đổi trả', 'Theo dõi khiếu nại', 'Câu hỏi thường gặp']} />,
