...
import {
  ...
  WalletCards,
  X,
  Warehouse, // ĐÃ THÊM ICON KHO HÀNG
} from "lucide-react";
...
const navItems = [
  ...
  { slug: "kho-hang", label: "Kho hàng", icon: Warehouse }, // ĐÃ THÊM MENU KHO HÀNG
            ...
            <button
              ...
              onClick={() =>
                onToast({
                  title: "Thêm sản phẩm",
                  message:
                    "Đã mở flow tạo sản phẩm mới tại bước thông tin cơ bản.",
                })
              }
            >
