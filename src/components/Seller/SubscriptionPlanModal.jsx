...
export const VENDOR_PLANS = [
  {
    ...
    displayDays: 7,
    features: [
      { label: 'Tối đa 3 tin đăng', included: true },
      { label: 'Thời hạn hiển thị 7 ngày', included: true },
      { label: 'Hiển thị tiêu chuẩn', included: true },
      { label: 'Ưu tiên hiển thị', included: false },
      { label: 'Nổi bật trong tìm kiếm', included: false },
  ...
  },
  {
    ...
    badgeType: 'popular',
    features: [
      { label: 'Tối đa 20 tin đăng', included: true },
      { label: 'Thời hạn hiển thị 15 ngày', included: true },
      { label: 'Hiển thị tiêu chuẩn', included: true },
      { label: 'Ưu tiên hiển thị', included: true },
      { label: 'Nổi bật trong tìm kiếm', included: false },
      { label: 'Đánh dấu tin nổi bật', included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { label: 'Thời hạn hiển thị 30 ngày', included: true },
      { label: 'Hiển thị tiêu chuẩn', included: true },
      { label: 'Ưu tiên hiển thị', included: true },
      { label: 'Nổi bật trong tìm kiếm', included: true },
