// Generated from Province Open API v1 (3-level administrative data before 07/2025 merger).
// Source: https://provinces.open-api.vn/api/v1/?depth=3
...
export const VIETNAM_ADDRESS_DATA = Object.fromEntries(
  VIETNAM_PROVINCES.map((province) => [
    province.name,
    Object.fromEntries(
      province.districts.map((district) => [district.name, district.wards]),
    ),
  ]),
);
